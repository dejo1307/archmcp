...
└──────────────────┘
   │
   ▼
┌──────────────────┐  Go · Java · Kotlin · Scala · JS/TS · Vue · Svelte ·
│   Extractors     │  Python · Swift · Ruby · Rust · C/C++ · PHP · OpenAPI
└──────────────────┘  (source → facts)
   │
   ▼
┌──────────────────┐
...
| `extractors` | Enabled extractors | `["cpp", "dotnet", "go", "grpc", "java", "kotlin", "openapi", "php", "python", "typescript", "swift", "ruby", "rust", "scala", "hcl", "ansible", "mdintent"]` |
